...
def run_async(
    ...
    **kwargs,
    ...
    stdout_stream = subprocess.PIPE if pipe_stdout else subprocess.DEVNULL if quiet else None
    stderr_stream = subprocess.PIPE if pipe_stderr else subprocess.DEVNULL if quiet else None
